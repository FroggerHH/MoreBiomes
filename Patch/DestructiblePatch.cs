...
public class DestructiblePatch
{
    ...
    {
        var column_ruins = __instance.GetPrefab("column_ruins").GetComponent<Piece>();
        Debug("column_ruins");
        var column_ruins_main = __instance.GetPrefab("column_ruins_main").GetComponent<Piece>();
        Debug("column_ruins_main");
        var column_ruins_footing = __instance.GetPrefab("column_ruins_footing").GetComponent<Piece>();
        Debug("column_ruins_footing");
        var TreasureChest_ancienttemple = __instance.GetPrefab("TreasureChest_ancient-temple").GetComponent<Piece>();
        Debug("TreasureChest_ancienttemple");
        var TreasureChest_DesertRuin = __instance.GetPrefab("TreasureChest_DesertRuin").GetComponent<Piece>();
        ...
        column_ruins.m_resources = requirements_10Stone.ToArray();
