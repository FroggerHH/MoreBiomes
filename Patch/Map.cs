...
public class Map
{
    private static Color[] mapTexture = null;
    private static Color[] combined = null;
    ...
    private static void Tooltip(Minimap __instance)
    {
        ...
        sb.AppendLine($"Map pos vanila: {mapPosX_vanila}, {mapPosY_vanila}");
        sb.AppendLine($"Map pos mod: {NoiseGenerator.WorldToMapPoint(worldPoint)}");
