...
public class Grass
{
    ...
    public static void AddGrassPatch(ClutterSystem __instance)
    {
        ...
        __instance.m_clutter.Add(new Clutter
        {
            ...
            m_maxAlt = instanced_heathgrass.m_maxAlt / 1.5f,
            m_maxTilt = instanced_heathgrass.m_maxTilt,
            m_minVegetation = instanced_heathgrass.m_minVegetation / 5f,
            m_maxVegetation = instanced_heathgrass.m_maxVegetation / 5f,
